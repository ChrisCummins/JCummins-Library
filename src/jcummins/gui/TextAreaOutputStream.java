...
public class TextAreaOutputStream extends OutputStream
{
	...
	static private byte[] LINE_SEP = System
	...
	public TextAreaOutputStream (JTextArea ta, int ml)
	{
		...
		{
			/*
			 * throw new IoEscape (IoEscape.GENERAL, "Maximum lines of " + ml +
	...
	public synchronized void write (byte[] ba, int str, int len)
	{
		try
		{
			...
			for (int xa = 0; xa < 10; xa++)
			{
				...
				{ // sometimes throws a java.lang.Error: Interrupted attempt to
					// aquire write lock
					if (xa == 9)
					{
						thr.printStackTrace ();
	...
	public static void main (String[] args)
	{
		...
		PrintStream con=new PrintStream(new TextAreaOutputStream(txt));
		System.setOut(con);
		System.setErr(con);
		
		System.out.println("hereler");
