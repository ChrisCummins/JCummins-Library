 ...
 * 
 */
public class CSettingsCollection {

	private final HashMap<String, CSetting> settings = new HashMap<String, CSetting>();

	public void add(CSetting c) {
		settings.put(c.key(), c);
	}

	public CSetting get(String key) {
